(self.AMP = self.AMP || []).push({
  ...
  f: function (t, e) {
    !(function () {
      ...
      function p(t) {
        return (
          ...
          (function (t, e) {
            ...
            ? m.userForEmbed || (m.userForEmbed = d())
            : m.user
        );
      }
      function d(t) {
      ...
      function g(t, e, a, r, n, i, o, s, c, l, u) {
        return t;
      }
      function b(t, e, a, r, n, i, o, s, c, l, u) {
        return p().assert(t, e, a, r, n, i, o, s, c, l, u);
      }
      function w(t, e) {
        return x(
          (t = (function (t) {
      ...
      function k(t, e) {
        var a,
          r,
          n = ((a = y(t)), (r = y(a)).isSingleDoc() ? r.win : r);
        return L(n, e) ? x(n, e) : null;
      }
      function y(t) {
        return t.nodeType
          ? ((a = t),
            (e = (a.ownerDocument || a).defaultView),
            w(e, 'ampdoc')).getAmpDoc(t)
          : t;
        var e, a;
      }
      function x(t, e) {
      ...
      function L(t, e) {
        var a = t.__AMP_SERVICES && t.__AMP_SERVICES[e];
        return !(!a || !a.ctor);
      }
      var O = {
          twitter: {
          ...
          pinterest: {
            ...
            defaultParams: { url: 'CANONICAL_URL', description: 'TITLE' },
          },
          linkedin: {
            shareEndpoint: 'https://www.linkedin.com/shareArticle',
            defaultParams: { url: 'CANONICAL_URL', mini: 'true' },
          },
          gplus: { obsolete: !0 },
          email: {
            bindings: ['recipient'],
        ...
        E = (function (t) {
          ...
          y.prerenderAllowed = function () {
            return !0;
          };
          var x = y.prototype;
          return (
            (x.isLayoutSupported = function () {
              return !0;
            }),
            (x.buildCallback = function () {
              var t = this,
                e = this.element,
                a = b(
                  e.getAttribute('type'),
              ...
              b(
                ...
                (this.Ks = w(this.win, 'platform'));
              var r = 'share' in this.win.navigator;
              if ('system' === a) {
                if (!r) return void u(e, !1);
              } else if (
                r &&
              ...
              if (n.obsolete)
                return (
                  u(e, !1),
                  void p().warn(C, 'Skipping obsolete share button '.concat(a))
                );
              (this.trt = b(
                e.getAttribute('data-share-endpoint') || n.shareEndpoint,
                ...
                Object.assign(
                  ...
                  (function (t, e, a) {
                    ...
                    for (var o in r) {
                      var s = o.match(i);
                      s && (n[s[1][0].toLowerCase() + s[1].substr(1)] = r[o]);
                    }
                    return n;
                  })(e),
                ),
                ...
                e.getAttribute('aria-label') ||
                  e.setAttribute('aria-label', 'Share by '.concat(a)),
                e.addEventListener('click', function () {
                  return t.fo();
                }),
                e.addEventListener('keydown', this.art.bind(this)),
                e.classList.add('amp-social-share-'.concat(a));
            }),
            (x.layoutCallback = function () {
              var t = this;
              if (!this.trt) return r || (r = Promise.resolve(void 0));
              var e = (function (t, e, a) {
                  ...
                  return (
                    n[0] +
                    (n[1] ? '?'.concat(n[1], '&').concat(e) : '?'.concat(e)) +
                    (r[1] ? '#'.concat(r[1]) : '')
                  );
                })(
                  this.trt,
                ...
                a = k(this.element, 'url-replace'),
                n = {};
              return (
                this.nrt &&
                  this.nrt.forEach(function (e) {
                    var a = e.toUpperCase();
                    n[a] = t.Yt[e];
                  }),
                a.expandUrlAsync(e, n).then(function (e) {
                  t.rrt = e;
                  var a,
                    r = ((a = t.element), k(a, 'url')).parse(e).protocol,
                    n = 'mailto:' === r,
                    i = 'sms:' === r;
                  (t.h =
                    t.Ks.isIos() && (n || i)
                      ? '_top'
                      : t.element.hasAttribute('data-target')
                        ? t.element.getAttribute('data-target')
                        : '_blank'),
                    i && (t.rrt = t.rrt.replace('?', '?&'));
                })
              );
            }),
            (x.art = function (t) {
              var e = t.key;
              (' ' != e && 'Enter' != e) || (t.preventDefault(), this.irt());
            }),
            (x.fo = function () {
              this.irt();
            }),
            (x.irt = function () {
              b(this.rrt && this.h, 'Clicked before href is set.');
              var t = this.rrt,
                r = this.h;
              if ('navigator-share:' === this.trt) {
                var n = this.win.navigator;
                g(n.share);
                ...
                !(function (t, e, a, r) {
                  ...
                  !n &&
                    '_top' != a &&
                    ('number' != typeof o && (o = 0),
                    o + 'noopener'.length > (i = r).length ||
                      -1 === i.indexOf('noopener', o)) &&
                    (n = t.open(e, '_top'));
                })(this.win, t, r, 'resizable,scrollbars,width=640,height=480');
            }),
            y
          );
        })(t.BaseElement);
