    ...
    !(function () {
      ...
      var o,
        ...
        f =
          ...
          function () {
            return o && (m = (0, o[t(o)[0]])((o = 0))), m;
          }),
        h =
          ((d = {
            'node_modules/timeago.js/dist/timeago.full.min.js': function (
              s,
              n,
            ) {
              var e, a;
              f(),
                ...
                (a = function (s) {
                  ...
                  var b = y.bind(
                    ...
                    z = y.bind(null, 'дзень', '%s дзень', '%s дні', '%s дзён'),
                    w = y.bind(
                      null,
                      'тыдзень',
                      '%s тыдзень',
                    ...
                    _ = y.bind(null, 'год', '%s год', '%s гады', '%s гадоў');
                  function M(s) {
                  ...
                  var T = S.bind(
                    ...
                    N = S.bind(null, 'час', '%s час', '%s часа', '%s часов'),
                    D = S.bind(null, 'день', '%s день', '%s дня', '%s дней'),
                    I = S.bind(
                      null,
                      'неделю',
                      '%s неделю',
                    ...
                    R = S.bind(null, 'год', '%s год', '%s года', '%s лет');
                  function C(s, n, e, a, t) {
                    var u = t % 10,
                      i = t % 100;
                    return 1 == t
                      ? s
                  ...
                  var E = C.bind(
                    ...
                    U = C.bind(null, '1 дан', '%s дан', '%s дана', '%s дана'),
                    B = C.bind(
                      null,
                      'недељу дана',
                      '%s недељу',
                  ...
                  var L = A.bind(
                    ...
                    H = A.bind(null, 'день', '%s день', '%s дні', '%s днів'),
                    K = A.bind(
                      null,
                      'тиждень',
                      '%s тиждень',
                    ...
                    V = A.bind(null, 'рік', '%s рік', '%s роки', '%s років'),
                    X = Object.freeze({
                      __proto__: null,
                      ar: function (s, n) {
                      ...
                      ro: function (s, n) {
                        ...
                        return s < 20
                          ? e[n]
                          : [
                              e[n][0].replace('%s', '%s de'),
                              e[n][1].replace('%s', '%s de'),
                            ];
                      },
                      ru: function (s, n) {
                        switch (n) {
                  ...
                  Object.keys(X).forEach(function (s) {
                    ...
                    (s.cancel = function (s) {
                      s ? g(f(s)) : Object.keys(h).forEach(g);
                    }),
                    (s.format = function (s, n, e) {
                      return d(c(s, e && e.relativeDate), i(n));
                    }),
                    (s.register = u),
                    (s.render = function (s, n, e) {
                      ...
                      return (
                        a.forEach(function (s) {
                          p(s, s.getAttribute('datetime'), i(n), e || {});
                        }),
                        a
                      );
                    }),
                ...
                'object' == (void 0 === s ? 'undefined' : r(s)) && void 0 !== n
                  ? a(s)
          ...
          function () {
            return (
              c || (0, d[t(d)[0]])((c = { exports: {} }).exports, c), c.exports
            );
          });
      function g(s, n) {
        return (g =
      ...
      var y = Object.prototype,
        b = (y.hasOwnProperty, y.toString, 'fixed');
      function j(s) {
        return (s.ownerDocument || s).defaultView;
      }
      function k(s) {
        return s.parent && s.parent != s;
      }
      function z(s, n) {
        var e =
          ...
          t = e.rootMargin,
          u = e.threshold,
          i = k(n) && (a || t) ? n.document : void 0;
        return new n.IntersectionObserver(s, {
          threshold: u,
          root: i,
          rootMargin: t,
        });
      ...
      var w = new WeakMap(),
        q = new WeakMap();
      function _(s) {
        for (var n = new Set(), e = s.length - 1; e >= 0; e--) {
          var a = s[e],
            t = a.target;
          if (!n.has(t)) {
            n.add(t);
            var u = q.get(t);
            if (u) for (var i = 0; i < u.length; i++) (0, u[i])(a);
          }
        }
      }
      ...
      var S = (function (s, r, o) {
          return (
            (o = null != s ? n(u(s)) : {}),
            (function (s, n, u, r) {
              if ((n && 'object' == typeof n) || 'function' == typeof n)
                for (var o, m = t(n), d = 0, c = m.length; d < c; d++)
                  (o = m[d]),
                    i.call(s, o) ||
                      void 0 === o ||
                      e(s, o, {
                        ...
                        enumerable: !(r = a(n, o)) || r.enumerable,
                      });
              return s;
            })(
              s && s.__esModule
                ? o
                : e(o, 'default', { value: s, enumerable: !0 }),
              s,
            )
          );
        })(h()),
        ...
        I = (function (s) {
            ...
            a =
              ...
              function () {
                ...
                if (e) {
                  ...
                  s = Reflect.construct(a, arguments, t);
          ...
          return (
            (u.buildCallback = function () {
              var s, n, e;
              (n = this.element.textContent.length > 0),
                (e = this.element),
                (M.user || (M.user = O()),
                void M.user.win
                  ? M.userForEmbed || (M.userForEmbed = O())
                  : M.user).assert(
                  n,
                ...
                (this.sj = this.element.getAttribute('datetime')),
                (this.yw =
                  ((s = (s =
                    this.element.getAttribute('locale') ||
                    this.win.document.documentElement.lang).toLowerCase()),
                  D[s]
                    ? D[s]
                    : 4 === s.length || 5 === s.length
                      ? ''
                          .concat(s.slice(0, 2), '_')
                          .concat(s.slice(-2).toUpperCase())
                      : s)),
                (this.kj = this.element.textContent.trim()),
                (this.element.textContent = ''),
                this.element.hasAttribute('role') ||
                  this.element.setAttribute('role', 'text'),
                (this.zj = document.createElement('time')),
                this.zj.setAttribute('datetime', this.sj),
                this.Dj(),
                this.element.appendChild(this.zj);
            }),
            (u.ag = function (s) {
              s && !this._j && this.Dj();
            }),
            (u.layoutCallback = function () {
              ...
              return (
                    ...
                    function () {
                      !(function (s, n) {
                        ...
                        if (
                          ...
                          var i = j(s),
                            r = w.get(i);
                          null == r || r.unobserve(s), q.delete(s);
                        }
                      })(s, n);
                    }
                  );
                ...
                l || (l = Promise.resolve(void 0))
              );
            }),
            (u.unlayoutCallback = function () {
              var s;
              return (
                null === (s = this.ug) || void 0 === s || s.call(this),
                (this.ug = null),
                !1
              );
            }),
            (u.mutatedAttributesCallback = function (s) {
              var n = s.datetime;
              void 0 !== n && ((this.sj = n), this.Dj());
            }),
            (u.isLayoutSupported = function (s) {
              return (function (s) {
                return (
                  s == b ||
                  'fixed-height' == s ||
            ...
            (u.Dj = function () {
              if (this.element.hasAttribute('cutoff')) {
                var s = parseInt(this.element.getAttribute('cutoff'), 10),
                  n = new Date(this.sj);
                Math.floor((Date.now() - n.getTime()) / 1e3) > s
                  ? ((this.zj.textContent = this.kj), (this._j = !0))
                  : (this.zj.textContent = x(this.sj, this.yw));
              } else this.zj.textContent = x(this.sj, this.yw);
            }),
            t
          );
        })(s.BaseElement);
      s.registerElement('amp-timeago', I);
    })();
